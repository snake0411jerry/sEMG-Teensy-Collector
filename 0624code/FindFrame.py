...
if __name__ == "__main__":
    VIDEO_FILE = r"D:\project\NCU\114\Jumior\AI Project\Dataset\0625\Open\OpenCapData_KUAN\Videos\Cam0\InputMedia\C\C_sync.mp4"
    START_WINDOW = (1, 2)   # 尋找亮燈的區間
    END_WINDOW = (31, 32)    # 尋找熄燈的區間
